...
def capture_face(profile_name, initial_balance):
    ...
    while True:
        ...
        if key == ord("s"):
            ...
            profiles[profile_name] = {"face": face_img, "balance": initial_balance}
            save_profiles(profiles)
            print(f"Profile {profile_name} with balance ${initial_balance} saved.")
            break
        elif key == ord("q"):
...
def authenticate():
    """Authenticate a user by matching their face and display their balance."""
    cam = cv2.VideoCapture(0)
    ...
    while True:
        ...
        if choice == "1":
            ...
            if profile_name in profiles:
                ...
                capture_face(profile_name, initial_balance)
        elif choice == "2":
            if not profiles:
